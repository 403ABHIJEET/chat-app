    ...
    <div className="relative flex w-full flex-col items-center justify-center">
      ...
      <div className="px-4 py-10 md:py-20 w-full">
        ...
        <motion.div
          ...
          className="w-full z-10 mt-8 flex flex-wrap items-center justify-center gap-4"
        >
          <Link href={`/chat`} >
        ...
        <div className="flex justify-center overflow-hidden">
          <motion.div
            ...
            className="w-full overflow-hidden relative z-10 mt-20 rounded-3xl border border-neutral-200 bg-neutral-100 p-4 shadow-md dark:border-neutral-800 dark:bg-neutral-900"
          >
  ...
  return (
    <nav className="flex w-full items-center justify-between border-t border-b border-neutral-200 px-4 py-4 dark:border-neutral-800">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-base font-bold md:text-2xl">Chat App</h1>
      </div>
